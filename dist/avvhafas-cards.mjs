...
let b = class extends HTMLElement {
  ...
  static getPropertyDescriptor(t, e, i) {
    const { get: n, set: r } = Et(this.prototype, t) ?? { get() {
      return this[e];
    }, set(o) {
      this[e] = o;
    } };
...
\f\r"'\`<>=]|("|')|))|$)`, "g"), it = /'/g, nt = /"/g, ut = /^(?:script|style|textarea|title)$/i, Ot = (s) => (t, ...e) => ({ _$litType$: s, strings: t, values: e }), f = Ot(1), A = /* @__PURE__ */ Symbol.for("lit-noChange"), h = /* @__PURE__ */ Symbol.for("lit-nothing"), rt = /* @__PURE__ */ new WeakMap(), v = y.createTreeWalker(y, 129);
function pt(s, t) {
...
const Ut = (s, t) => {
  ...
  for (let l = 0; l < e; l++) {
    const a = s[l];
    let d, u, c = -1, p = 0;
    for (; p < a.length && (o.lastIndex = p, u = o.exec(a), u !== null); ) p = o.lastIndex, o === H ? u[1] === "!--" ? o = et : u[1] !== void 0 ? o = st : u[2] !== void 0 ? (ut.test(u[2]) && (n = RegExp("</" + u[2], "g")), o = g) : u[3] !== void 0 && (o = g) : o === g ? u[0] === ">" ? (o = n ?? H, c = -1) : u[1] === void 0 ? c = -2 : (c = o.lastIndex - u[2].length, d = u[1], o = u[3] === void 0 ? g : u[3] === '"' ? nt : it) : o === nt || o === it ? o = g : o === et || o === st ? o = H : (o = g, n = void 0);
    const $ = o === g && s[l + 1].startsWith("/>") ? " " : "";
    r += o === H ? a + Tt : c >= 0 ? (i.push(d), a.slice(0, c) + ct + a.slice(c) + m + $) : a + m + (c === -2 ? l : $);
  }
    ...
    for (; (n = v.nextNode()) !== null && a.length < l; ) {
      if (n.nodeType === 1) {
        if (n.hasAttributes()) for (const c of n.getAttributeNames()) if (c.endsWith(ct)) {
          const p = u[o++], $ = n.getAttribute(c).split(m), U = /([.?@])?(.*)/.exec(p);
          a.push({ type: 1, index: r, name: U[2], strings: $, ctor: U[1] === "." ? Rt : U[1] === "?" ? Vt : U[1] === "@" ? It : L }), n.removeAttribute(c);
        } else c.startsWith(m) && (a.push({ type: 6, index: r }), n.removeAttribute(c));
        if (ut.test(n.tagName)) {
          const c = n.textContent.split(m), p = c.length - 1;
          if (p > 0) {
            n.textContent = V ? V.emptyScript : "";
            for (let $ = 0; $ < p; $++) n.append(c[$], M()), v.nextNode(), a.push({ type: 2, index: ++r });
            n.append(c[p], M());
          }
        }
...
class Dt {
  ...
  u(t) {
    const { el: { content: e }, parts: i } = this._$AD, n = (t?.creationScope ?? y).importNode(e, !0);
    v.currentNode = n;
    let r = v.nextNode(), o = 0, l = 0, a = i[0];
    for (; a !== void 0; ) {
      if (o === a.index) {
        let d;
        a.type === 2 ? d = new O(r, r.nextSibling, this, t) : a.type === 1 ? d = new a.ctor(r, a.name, a.strings, this, t) : a.type === 6 && (d = new Lt(r, this, t)), this._$AV.push(d), a = i[++l];
      }
...
class O {
  ...
  constructor(t, e, i, n) {
    this.type = 2, this._$AH = h, this._$AN = void 0, this._$AA = t, this._$AB = e, this._$AM = i, this.options = n, this._$Cv = n?.isConnected ?? !0;
  }
  get parentNode() {
  ...
  $(t) {
    const { values: e, _$litType$: i } = t, n = typeof i == "number" ? this._$AC(t) : (i.el === void 0 && (i.el = T.createElement(pt(i.h, i.h[0]), this.options)), i);
    if (this._$AH?._$AD === n) this._$AH.p(e);
    else {
      const r = new Dt(n, this), o = r.u(this.options);
  ...
  k(t) {
    ...
    const e = this._$AH;
    let i, n = 0;
    for (const r of t) n === e.length ? e.push(i = new O(this.O(M()), this.O(M()), this, this.options)) : i = e[n], i._$AI(r), n++;
...
class L {
  ...
  constructor(t, e, i, n, r) {
    this.type = 1, this._$AH = h, this._$AN = void 0, this.element = t, this.name = e, this._$AM = n, this.options = r, i.length > 2 || i[0] !== "" || i[1] !== "" ? (this._$AH = Array(i.length - 1).fill(new String()), this.strings = i) : this._$AH = h;
  }
  _$AI(t, e = this, i, n) {
    const r = this.strings;
    let o = !1;
    if (r === void 0) t = E(this, t, e, 0), o = !P(t) || t !== this._$AH && t !== A, o && (this._$AH = t);
    else {
      const l = t;
      let a, d;
      for (t = r[0], a = 0; a < r.length - 1; a++) d = E(this, l[i + a], e, a), d === A && (d = this._$AH[a]), o ||= !P(d) || d !== this._$AH[a], d === h ? t = h : t !== h && (t += (d ?? "") + r[a + 1]), this._$AH[a] = d;
    }
    o && !n && this.j(t);
  }
  j(t) {
...
class It extends L {
  ...
  _$AI(t, e = this) {
    ...
    const i = this._$AH, n = t === h && i !== h || t.capture !== i.capture || t.once !== i.once || t.passive !== i.passive, r = t !== h && (i === h || n);
...
const kt = (s, t, e) => {
  ...
  if (n === void 0) {
    ...
    i._$litPart$ = n = new O(t.insertBefore(M(), r), r, void 0, e ?? {});
  }
  return n._$AI(s), n;
};
const W = globalThis;
...
function $t(s, t) {
  const e = new Date(s), i = new Date(t), n = Math.abs(+e - +i);
...
function _t(s, t, e, i, n, r) {
  return s.length === 0 || !t || t.mode !== "walking" ? s : $t(t.departure, t.arrival) > e ? (r && (t[n] = r), s) : i(s);
}
function Kt(s) {
  return s.filter(
...
function Qt(s) {
  return s.forEach((t, e) => {
    ...
    const i = e > 0 ? s[e - 1] : void 0, n = e + 1 < s.length ? s[e + 1] : void 0;
    i && (t.origin = i.destination, t.platform = i.platform_arrival), n && (t.destination = n.origin, t.platform_arrival = n.platform);
  }), s;
}
...
const ie = { CHILD: 2 }, ne = (s) => (...t) => ({ _$litDirective$: s, values: t });
class re {
  constructor(t) {
  }
  get _$AU() {
...
var oe = Object.defineProperty, ae = Object.getOwnPropertyDescriptor, S = (s, t, e, i) => {
  for (var n = i > 1 ? void 0 : i ? ae(t, e) : t, r = s.length - 1, o; r >= 0; r--)
...
let _ = class extends w {
  ...
  renderHeadline(s, t, e) {
    if (!s || !t) return h;
    const i = mt(this.now, t), n = i <= 0 ? "jetzt" : `in ${i} min`;
  ...
  renderStations(s, t, e) {
    ...
    let n = t ? this.renderStation(t, !1) : h;
    return n = n !== h && !Ft(i.values, n.values) ? n : h, f`
      <div class="${t ? "slim" : ""}">
        <div class="symbols">
          <div class="delay">
        ...
        <div>${this.renderStation(s, e)} ${n}</div>
      </div>
    `;
  }
  formatDate(s) {
  ...
  formatStationName(s) {
    ...
    for (const e of this.searchReplace) {
      const [i, n] = e.split("/", 2);
      t = t.replaceAll(new RegExp(i, "gi"), n ?? "");
    }
    return t.trim();
  }
  renderStation(s, t) {
...
let N = class extends w {
  ...
  render() {
    ...
    const i = this.config.color ?? gt, n = this.config.gradient1 ?? vt, r = this.config.gradient2 ?? yt, o = [
      `--gradient1: rgb(${n.join(", ")})`,
      `--gradient2: rgb(${r.join(", ")})`,
      `--color: rgb(${i.join(", ")})`,
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
